...
'''
Using PyRosetta to fast relax pdbs and pump them into a directory.
'''
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to the folder containing input PDBs",
    )
    parser.add_argument(
        "-o",
        "--output",
        type=str,
        default=None,
        help="Path to the output folder (default: the first part of the file name + 'relaxed')",
    )
    parser.add_argument(
        "-p",
        "--prefix",
        type=str,
        default="relaxAF_apo_relaxed",
        help="Output file name prefix (default: 'relaxAF_apo_relaxed')",
    )
    ...
    output_folder = (
        ...
        else os.path.join(os.path.dirname(input_folder), args.prefix)
    )
