        ...
        if pdb_file.endswith(".pdb"):
            ...
            if sample_number_match:
                ...
                if sample_number in sample_numbers:
                    ...
                    print(f"Extracted PDB {pdb_file} with sample number {sample_number}.")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Extract PDB files based on sample numbers in an index file")
    parser.add_argument("-i", "--input_folder", type=str, required=True, help="Input folder containing PDB files")
    parser.add_argument("-n", "--index", type=str, required=True, help="Path to the index txt file")
    parser.add_argument("-o", "--output_folder", type=str, help="Output folder for extracted PDB files")
